...
bool ServoHatDriver::init(eros::Logger* _logger,int address) {
    ...
    wiringPiI2CWriteReg8(servoHatFd, (int)Adafruit16ChServoHatConstant::MODE2, (int)Adafruit16ChServoHatConstant::OUTDRV);
    wiringPiI2CWriteReg8(servoHatFd, (int)Adafruit16ChServoHatConstant::MODE1, (int)Adafruit16ChServoHatConstant::ALLCALL);
